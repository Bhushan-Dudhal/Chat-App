...
class AuthService {
  ...
  Future<UserModel?> sigInWithEmailAndPassword(
    String email,
    String password,
  ) async {
    try {
  ...
  Future<void> sendPasswordResetEmail(String email) async {
    try {
      ...
      throw Exception("Fail To Send Password Reset Email ");
    }
  }
  ...
  Future<void> signOut() async {
    try {
      ...
      throw Exception("Fail To SignOut:${e}");
    }
  }
  ...
  Future<void> deleteAccount() async {
    try {
      ...
      throw Exception("Fail To Delete Account :${e}");
    }
  }
}
